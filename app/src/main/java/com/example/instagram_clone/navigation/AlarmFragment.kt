    ...
    inner class AlarmRecyclerviewAdapter: RecyclerView.Adapter<RecyclerView.ViewHolder>(){
        ...
        override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
            ...
            when(alarmDTOList[position].kind){
                0 -> {
                    val str_0 = alarmDTOList[position].userId
                    val str_1 = getString(R.string.alarm_favorite)
                    view.commentviewitem_textview_profile.text = str_0
                    view.commentviewitem_textview_comment.text = str_1
                }
                1 -> {
                    val str_0 = alarmDTOList[position].userId
                    val str_1 = getString(R.string.alarm_comment) + " of " + alarmDTOList[position].message
                    view.commentviewitem_textview_profile.text = str_0
                    view.commentviewitem_textview_comment.text = str_1
                }
                2 -> {
                    val str_0 = alarmDTOList[position].userId
                    val str_1 = getString(R.string.alarm_follow)
                    view.commentviewitem_textview_profile.text = str_0
                    view.commentviewitem_textview_comment.text = str_1
                }
            }
